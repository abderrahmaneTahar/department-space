...
<div class="container" id="ap">
  <div class="row justify-content-center" style="margin-top: 100px;margin-left: 200px;">
     <div class="col-md-11" style="background-color: #F7F7F7; border: 5px solid #f7f7f7;box-shadow: 0 2px 2px rgba(0,0,0,0.3);border-radius: 2%;margin-top: -25px;">

          <form enctype="multipart/form-data" action="{{url('publications/'.$publication->id)}}" method="post">
               <input type="hidden" name="_method" value="PUT">
               {{csrf_field()}}
               <div class="form-group">
                    <label for="">titre :</label>
                    <input type="text" name="titre" class="form-control"
                    value="{{$publication->titre}}" style="background-color: white;border: 1px solid #2A8CA9;">
               </div>

               <div class="form-group">
                    <label for="">body :</label>
                    <textarea name="body" class="form-control" style="height: 100px;background-color: white;border: 1px solid #2A8CA9;">{{$publication->body}}</textarea>
               </div>
               ...
               <div class="form-group">
                    ...
                    <input type="file" name="file" class="btn btn-default " value="{{$publication->file}}">
               </div>
               ...
               <div class="form-group">
                    <label for=""></label>
                    <input type="submit" value="Modifier" class="btn " style="float: right;background-color: #2A8CA9 ;color: #fff;margin-right: 20px;margin-bottom: 20px;width: 100px;">
               </div>
          </form>
     </div>
 </div>
