...
<div class="container">
    <div class="row justify-content-center" style="margin-top: 100px;margin-left: 200px;">
       ...
       <a href="{{url('/messages/sent')}}">
        <h4 class="btn btn-default"  style="float: right; background-color: white; color:#005B8E;margin-bottom: 10px; border: 1px solid #005B8E;box-shadow: 0 2px 2px rgba(0,0,0,0.3);font-weight: 500;"> Messages envoyés >></h4>
       </a>
        ...
        <body>
          ...
          @if($message->read)
            ...
            @endif
          	 ...
          	 <td style="width: 150px;"><a href="{{url('/profile/'.$message->sender->id)}}" style="text-decoration: none;color: #000">
            	...
            	<h6 style="margin-left: 50px;margin-top: 13px;">{{$message->sender->name}}</h6></a>
            </td>
            <td style="width: 100px;">
            	<h6 style="margin-top: 13px;font-weight: 400;">{{$message->created_at}}</h6>
            </td>
